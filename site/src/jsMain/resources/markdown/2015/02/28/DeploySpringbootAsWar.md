...
date: "2015-02-28"
routeOverride: "/2015/02/28/deploy-springboot-as-war"
---
...
Of course, now I have an Initializer in my code even when I run the executable jar. It doesn't hurt much, but its more invasive then I want it to be. I could think of generating the Servlet-Initializer based on the chosen profile, since it only has to add one class to the sources. I'll keep you updated.
